...
class TextGenerator:
    ...
    def prompt(self):
        ...
        user_msg = (
            ...
            f"with each entry indexed by time, having one 'type' of work "
            f"(e.g., 'WriteDocumentTask') and one 'descriptor'.")
        ...
        assistant_msg = ("Generate a detailed and creative daily routine in a "
                         ...
                         "list. Each task should include a unique and "
        ...
        system_msg = ("This is a task to create a simulated daily routine for "
                      ...
                      "routine should be creative and detailed, following a "
                      "specific format.")
