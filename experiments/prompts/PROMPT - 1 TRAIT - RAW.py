...
class BasicTextGenerator:
    ...
    def prompt(self, adverb, adjective):
        ...
        user_msg = (
            f"Create a daily routine for an individual who is {adjective}."
...
if __name__ == "__main__":
    ...
    base_output_dir = f'{adjective}_output_raw'  # Updated directory
    ...
    for i in range(50):
        ...
        if response_content:
            ...
            filename = os.path.join(base_output_dir,
                                    f'{i + 1}_{adjective}_output_{timestamp}.txt')
