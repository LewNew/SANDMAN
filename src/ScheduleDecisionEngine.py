...
class ScheduleDecisionEngine(DecisionEngine.DecisionEngine):
    ...
    def make_decision(self):
        ...
        if len(self._task_list.taskList) == 1:
            ...
            print(f"\n\n[*] {self.COLOR_BLUE}LLM Decision:"
                  f" {self.COLOR_YELLOW}" +
                  decision, {self.COLOR_RESET}),
            ...
            for task in self._task_list:
                ...
                if task.Name in decision:
                    print(f"[*] {self.COLOR_GREEN}MATCH: " + task.Name + " - " +
                          "Decision: ", decision, {self.COLOR_RESET}),
                    match = True
    ...
    def execute_task(self):
        ...
        print(f"[*] Executing task: {self.COLOR_YELLOW}{self._current_task.Name}"
              f"{self.COLOR_RESET}")
        print(f"[*] Executing task: {self.COLOR_YELLOW}"
        ...
        try:
            ...
            print(f"[*] Time Property of Current Task:"
                  f" {self.COLOR_YELLOW}{self._current_task._time}{self.COLOR_RESET}")
            pass
        except:
            pass
